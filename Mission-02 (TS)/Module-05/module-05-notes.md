...
- Array, Object, {Tuples *(a special type of Array) -> [Fixed Length and Ordered Types]* }
- optional type(?)
- Literal Type

### What is a Literal Type?
> A literal type means a type that **represents exactly one specific value**, *not just a general category of values*.
...
- Shortly we can say:
 - **any**: *“Do whatever I want, TypeScript, I don’t care.”* → **Unsafe**
 - **unknown**: *“I don’t know the type yet, TypeScript, but force me to check before using.”* → **Safe**
